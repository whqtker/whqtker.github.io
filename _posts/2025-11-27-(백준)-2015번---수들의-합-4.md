...
![Pasted image 20251127142817.png](Pasted%20image%2020251127142817.png)
...
for문에서 $O(N)$, map에서 $O(log(N))$이다. map은 내부적으로 레드-블랙 트리로 구현되어 있으므로, 삽입 및 조회 시의 시간복잡도가 $(Olog(N))$이다. 
